...
const cacheName = 'FixitLevelUp3CyrusQuinn-2020-11-21 16:37:18.052699'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'FixitLevelUp3CyrusQuinn'.length) === 'FixitLevelUp3CyrusQuinn') {
